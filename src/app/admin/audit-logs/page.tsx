  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3 md:hidden">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-white py-16 shadow-sm">
          ...
          <div className="rounded-2xl bg-white px-5 py-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm font-medium text-slate-500">The governance event stream could not be loaded.</p>
            <Button asChild variant="outline" className="mt-4 rounded-xl border-2 font-bold">
          ...
          logs?.map((log) => (
            <button
              ...
              className="w-full rounded-2xl bg-white px-4 py-4 text-left shadow-sm transition-colors hover:bg-slate-50 active:scale-[0.99]"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1 space-y-2">
                  <div className="flex flex-wrap items-center gap-2">
                    <Badge
                      variant="secondary"
                      className="rounded-lg border-none bg-slate-100 px-2 py-0.5 text-[9px] font-black uppercase tracking-widest text-slate-600"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="truncate text-xs font-bold text-slate-700">{log.actorEmail}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Database className="h-3 w-3 shrink-0 text-slate-300" />
                    <div className="min-w-0 flex flex-col">
                      <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                        {log.targetType}
                      </span>
                      <span className="truncate text-[10px] font-medium text-slate-400">{log.targetId}</span>
                    </div>
                  </div>
                </div>
      ...
      {/* Desktop: the original table layout. */}
