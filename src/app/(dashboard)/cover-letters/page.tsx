...
export default function CoverLettersPage() {
  ...
  const editorReturnHref = `/cv-editor?returnTo=${encodeURIComponent("/cover-letters")}`
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 px-4 pb-20 pt-4 md:px-8 md:pt-8">
        ...
        <div className="relative space-y-8">
          <div className="space-y-6">
            <div className="max-w-none space-y-6">
              <h1 className="headline-gradient-vivid w-full pb-2 text-[1.85rem] font-black leading-[1.12] tracking-[-0.03em] sm:text-[2.6rem] lg:text-[3.6rem] xl:text-[4.2rem]">
                Generate stronger letters, then keep refining them like assets.
              </h1>
              <p className="max-w-3xl text-sm leading-relaxed text-slate-500 sm:text-base md:text-lg font-medium">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 rounded-2xl border border-slate-100 bg-white px-5 py-2.5 shadow-sm transition-all hover:border-indigo-100 hover:shadow-md">
                  <div className="h-2 w-2 rounded-full bg-indigo-500 animate-pulse" />
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">{plan} plan</span>
                </div>
                <div className="flex items-center gap-2 rounded-2xl border border-slate-100 bg-white px-5 py-2.5 shadow-sm transition-all hover:border-emerald-100 hover:shadow-md">
                  <span className="text-emerald-600 font-black text-sm">{resumes?.length || 0}</span>
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Resume sources</span>
                </div>
                <div className="flex items-center gap-2 rounded-2xl border border-slate-100 bg-white px-5 py-2.5 shadow-sm transition-all hover:border-amber-100 hover:shadow-md">
                  <span className="text-amber-600 font-black text-sm">{letters?.length || 0}</span>
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Saved letters</span>
                </div>
              </div>
            </div>

            <div className="flex w-full flex-col gap-4 border-t border-slate-100/50 pt-8 sm:flex-row sm:items-center sm:justify-between">
              <div className="group relative w-full min-w-0 sm:min-w-[320px]">
          ...
          <CardContent className="flex flex-col gap-6 p-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button className="tap-bounce h-12 rounded-2xl bg-indigo-600 px-8 font-black text-white hover:bg-indigo-700" asChild>
                <Link href={editorReturnHref}>Build New Resume</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      {isLoading ? (
          ...
          {filteredLetters.map((letter) => {
            ...
            return (
              <Card key={letter.id} className="surface-card group flex h-full flex-col overflow-hidden border-none transition-all duration-300 hover:-translate-y-2">
                ...
                <CardFooter className="grid grid-cols-2 gap-3 p-8 pt-0 sm:grid-cols-[1fr_auto_auto]">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="tap-bounce h-12 w-full rounded-2xl bg-slate-50 text-slate-600 transition-all hover:bg-slate-900 hover:text-white sm:w-12"
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="tap-bounce col-span-2 h-12 w-full rounded-2xl bg-rose-50 text-rose-500 transition-all hover:bg-rose-500 hover:text-white sm:col-span-1 sm:w-12"
        ...
        <div className="flex flex-col items-center justify-center space-y-8 rounded-[3rem] border-4 border-dashed border-slate-50 px-6 py-24 text-center bg-slate-50/30">
          <div className="relative w-full max-w-[340px] aspect-[4/3] animate-in zoom-in-95 duration-1000">
            <Image 
              src="/illustrations/cl-empty.png" 
              alt="No cover letters" 
              fill 
          ...
          <div className="max-w-md space-y-3">
            ...
            <p className="text-base font-medium leading-relaxed text-slate-500 italic">
              {searchTerm
