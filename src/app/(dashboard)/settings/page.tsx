  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 pb-24 md:space-y-8 md:px-8 md:pb-0">
      <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="headline-gradient-vivid pb-1 text-2xl font-black md:text-4xl">Settings</h1>
          <p className="text-sm font-medium text-muted-foreground">Control your profile, billing, and account recovery paths.</p>
        </div>
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="mb-8 flex h-auto w-full justify-start gap-2 overflow-x-auto overflow-y-hidden whitespace-nowrap rounded-[1.2rem] border border-white/80 bg-white/70 p-1.5 shadow-[0_18px_44px_-30px_rgba(15,23,42,0.24)] backdrop-blur-sm no-scrollbar scroll-smooth">
          <TabsTrigger value="profile" className="rounded-[0.95rem] border border-transparent bg-transparent px-4 py-2.5 text-[0.68rem] font-black uppercase tracking-widest text-muted-foreground data-[state=active]:border-primary/10 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm">Profile</TabsTrigger>
          <TabsTrigger value="billing" className="rounded-[0.95rem] border border-transparent bg-transparent px-4 py-2.5 text-[0.68rem] font-black uppercase tracking-widest text-muted-foreground data-[state=active]:border-primary/10 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm">Billing & Plans</TabsTrigger>
          <TabsTrigger value="security" className="rounded-[0.95rem] border border-transparent bg-transparent px-4 py-2.5 text-[0.68rem] font-black uppercase tracking-widest text-muted-foreground data-[state=active]:border-primary/10 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm">Security</TabsTrigger>
        </TabsList>
            ...
            <CardContent className="p-5 pt-0 md:p-8 md:pt-0">
              <form onSubmit={handleUpdateProfile} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[0.68rem] font-bold text-muted-foreground">Authenticated email cannot be changed here.</p>
                </div>
                <div className="flex justify-end">
                  <Button type="submit" className={cn(settingsActionButtonBase, "bg-primary px-10 text-white shadow-lg shadow-primary/15 hover:-translate-y-0.5 hover:bg-primary/90")} disabled={isSaving}>
                    ...
                    <span className="flex flex-col items-start leading-none">
                      ...
                      <span className="mt-1 text-[0.68rem] font-bold uppercase tracking-[0.16em] text-white/70">Update profile</span>
                    </span>
                  </Button>
                </div>
              </form>
    ...
    <div className="space-y-4 pb-2">
      <section className="rounded-[1.6rem] border border-white/80 bg-[linear-gradient(160deg,rgba(255,255,255,0.98),rgba(244,247,255,0.96))] px-4 py-4 shadow-[0_28px_60px_-42px_rgba(15,23,42,0.35)]">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[0.7rem] font-bold uppercase tracking-[0.22em] text-muted-foreground">Account center</p>
          ...
          <Badge className="rounded-full border-primary/20 bg-primary/5 px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.18em] text-primary">
