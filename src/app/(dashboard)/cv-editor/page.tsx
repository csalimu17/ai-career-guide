...
export default function CvEditorPage() {
  ...
  // Show the loader while EITHER the resume is loading OR we haven't yet
  // resolved the viewport size on the client. Without the second condition,
  // mobile users see DesktopEditor briefly hydrate, then visibly swap to
  // MobileEditor when the resize listener fires.
  if ((isLoading && !resume) || isMobile === undefined) {
    return (
