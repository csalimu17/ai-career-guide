                  ...
                  <div className="flex min-h-0 flex-1 flex-col">
                    <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 pb-28 pt-4">
                      ...
                      <div className="mt-5 space-y-2">
                        <p className="px-2 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-muted-foreground">
                          Main pipeline
                        </p>
                        {MOBILE_PRIMARY_NAV_ITEMS.map((item) => (
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              ...
                              <p className={cn("text-[0.65rem] font-semibold uppercase tracking-[0.18em]", isMobileNavActive(pathname, item.href) ? "text-white/70" : "text-muted-foreground")}>
                                {item.shortLabel}
                              </p>
                            </div>
                          </Link>
