...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/70 bg-white/76 backdrop-blur-xl">
        ...
        <div className="grid gap-5 sm:grid-cols-3">
          <div className="space-y-3">
            ...
            <div className="grid gap-2 text-[0.92rem]">
              <Link href="/cv-builder" className="text-muted-foreground transition-colors hover:text-primary">
                CV Builder
              </Link>
              <Link href="/ats-cv-checker" className="text-muted-foreground transition-colors hover:text-primary">
                ATS CV Checker
              </Link>
      ...
      <div className="app-shell border-t border-white/40 py-6">
        <p className="text-[0.85rem] text-muted-foreground">
          &copy; {new Date().getFullYear()} AI Career Guide. All rights reserved. Registered in the UK.
        </p>
      </div>
    </footer>
  );
