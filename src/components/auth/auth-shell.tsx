      ...
      <div className="app-shell relative z-10 flex min-h-[calc(100dvh-1.5rem)] flex-col gap-4 sm:min-h-[calc(100vh-3rem)] sm:gap-6 lg:gap-10">
        <div className="flex items-center justify-between max-md:gap-2">
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/75 px-3.5 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-muted-foreground shadow-sm backdrop-blur transition-colors hover:text-primary"
            >
