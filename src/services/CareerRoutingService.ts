...
export class CareerRoutingService {
  /**
   * Classifies the user's input into one of the specialized career roles.
   */
  static async classify(text: string): Promise<RoutingResult> {
  ...
  /**
   * Generates a response based on the selected role and the user's resume context.
   */
